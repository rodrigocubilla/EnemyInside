...
public class KillZone : MonoBehaviour
{
    ...
    public bool blocked;
    private bool prevBlocked = false;

    public bool hasPointToBlock = false;

    [SerializeField] private PointToBlock[] pointsToBlock; // Array de puntos a bloquear

    public delegate void ZoneBlockedHandler(KillZone zone);

    // 2) Declaras el evento basado en ese delegado.
    public event ZoneBlockedHandler OnBlocked;
